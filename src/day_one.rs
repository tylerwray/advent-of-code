...
pub fn check_module_mass() {
    ...
    println!("Total module mass is: {}", total_mass)
}

pub fn check_fuel_mass() {
    let mut total_mass = 0;
    ...
    println!("Total module mass, plus fuel mass, is: {}", total_mass)
}
